...
// 1. ВИПРАВЛЕНО: Імпортуємо правильну назву стору (зазвичай це useModalStore)
import { useModalStore } from '../../../components/addComponentModal/modalStore';
...
// 2. ВИПРАВЛЕНО: Називаємо змінну інакше, щоб не було конфлікту з імпортом
